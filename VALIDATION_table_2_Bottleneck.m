% This code generates the validation table 2 for bottleneck distance published 
...
for iter=1:nrepeats
    ...
    % Observed statistics
    observed_distance = PH_bottleneck2(avg_C1,avg_C2);
    ...
    for i=1:per_s % each iteration gives a permutation
        ...
        stat_s(i,iter) = PH_bottleneck2(avg_xper,avg_yper);
     end
end
toc
